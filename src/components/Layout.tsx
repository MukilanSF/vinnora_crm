...
import { LayoutDashboard, Users, UserCheck, Handshake, Receipt, Plus, Settings, LogOut, TrendingUp } from 'lucide-react';
import Logo from './Logo';
import ThemeToggle from './ThemeToggle';

interface LayoutProps {
  children: React.ReactNode;
  activeTab: 'homepage' | 'leads' | 'customers' | 'deals' | 'billing' | 'deals-list' | 'support-tickets';
  onTabChange: (tab: 'homepage' | 'leads' | 'customers' | 'deals' | 'billing' | 'deals-list' | 'support-tickets') => void;
  onNewNote: () => void;
  onShowSettings: () => void;
  onLogout: () => void;
  currentUser: any;
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange, onNewNote, onShowSettings, onLogout, currentUser }) => {
  const tabs = [
      ...
      <div className="w-64 bg-gradient-to-b from-orange-500 to-orange-600 text-white flex flex-col">
        ...
        <div className="p-6 border-b border-orange-400">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-bold">Vinnora CRM</h1>
              <p className="text-orange-100 text-sm">Built in India, for Indians</p>
        ...
        <div className="p-4 border-t border-orange-400">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-orange-100">admin@vinnora.com</p>
              <p className="text-xs text-orange-200">Plan: free</p>
            </div>
          </div>
        ...
        <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <ThemeToggle />
              {/* Removed "+Add Note" button from header */}
            </div>
          </div>
        </header>
